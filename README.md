...
- **Фільтрація динамічних об'єктів (YOLOv11-Seg)**: Автоматичне нейромережеве маскування автомобілів, людей та інших рухомих об'єктів під час створення еталонної бази, що гарантує прив'язку лише до стабільної геометрії (доріг, будівель).
